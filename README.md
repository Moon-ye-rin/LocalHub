...
상세 변경은 `docs/기능추가_v1.9.md`를 확인하세요.


## v2.0 i18n

- 상단의 `KO / EN` 버튼으로 한국어와 영어를 전환할 수 있습니다.
- 선택 언어는 브라우저에 저장됩니다.
- 지역정보의 카테고리·지역·UI와 챗봇은 영어를 지원합니다.
- TourAPI 장소명과 주소는 공공누리 제3유형의 변경금지 조건 때문에 한국어 원문을 유지합니다.
